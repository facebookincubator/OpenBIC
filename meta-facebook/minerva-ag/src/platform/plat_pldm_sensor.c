	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			UBC1_P50V_VIN_VOLT_V, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			UBC1_P12V_VOLT_V, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			UBC2_P50V_VIN_VOLT_V, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			UBC2_P12V_VOLT_V, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
...
PDR_sensor_auxiliary_names plat_pdr_sensor_aux_names_table[] = {
	...
	},
	{
		...
		.terminus_handle = 0x0000,
		.sensor_id = UBC1_P50V_VIN_VOLT_V,
		.sensor_count = 0x1,
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"UBC1_P50V_VIN_VOLT_V",
	},
	{
	...
	},
	{
		...
		.terminus_handle = 0x0000,
		.sensor_id = UBC2_P50V_VIN_VOLT_V,
		.sensor_count = 0x1,
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"UBC2_P50V_VIN_VOLT_V",
	},
	{
